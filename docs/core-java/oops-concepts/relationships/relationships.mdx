...
**Object-Oriented Programming**: _Association, Aggregation, and Composition_.
...
```java Department.java icon="java"
class Department {
    String name;
